...
namespace Repository.Migrations
{
    ...
    [Migration("20250810053016_updatenewdb")]
            ...
            modelBuilder.Entity("Repository.Entities.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7144),
                            Description = "Số lần swipe tối đa mỗi ngày",
                            KeyName = "max_swipes_per_day",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7144),
                            Value = "50"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7146),
                            Description = "Rating tối thiểu để hiển thị gia sư",
                            KeyName = "min_tutor_rating",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7146),
                            Value = "3.0"
                        },
                        new
                        {
                            Id = 3L,
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7148),
                            Description = "Số lần super like mỗi ngày",
                            KeyName = "super_like_limit",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7148),
                            Value = "5"
                        },
                        new
                        {
                            Id = 4L,
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7150),
                            Description = "Bật/tắt tính năng chat AI",
                            KeyName = "chat_ai_enabled",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7150),
                            Value = "true"
                        });
                });
            ...
            modelBuilder.Entity("Repository.Entities.Subject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "MATH",
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(6999),
                            IsActive = true,
                            Name = "Toán học",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(6999)
                        },
                        new
                        {
                            Id = 2L,
                            Category = "Khoa học tự nhiên",
                            Code = "PHYSICS",
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7002),
                            IsActive = true,
                            Name = "Vật lý",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7002)
                        },
                        new
                        {
                            Id = 3L,
                            Category = "Khoa học tự nhiên",
                            Code = "CHEMISTRY",
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7005),
                            IsActive = true,
                            Name = "Hóa học",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7005)
                        },
                        new
                        {
                            Id = 4L,
                            Category = "Khoa học tự nhiên",
                            Code = "BIOLOGY",
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7007),
                            IsActive = true,
                            Name = "Sinh học",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7007)
                        },
                        new
                        {
                            Id = 5L,
                            ...
                            Code = "LITERATURE",
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7009),
                            IsActive = true,
                            Name = "Văn học",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7010)
                        },
                        new
                        {
                            Id = 6L,
                            Category = "Ngoại ngữ",
                            Code = "ENGLISH",
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7012),
                            IsActive = true,
                            Name = "Tiếng Anh",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7012)
                        },
                        new
                        {
                            Id = 7L,
                            Category = "Khoa học xã hội",
                            Code = "HISTORY",
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7014),
                            IsActive = true,
                            Name = "Lịch sử",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7014)
                        },
                        new
                        {
                            Id = 8L,
                            Category = "Khoa học xã hội",
                            Code = "GEOGRAPHY",
                            CreatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7016),
                            IsActive = true,
                            Name = "Địa lý",
                            UpdatedAt = new DateTime(2025, 8, 10, 5, 30, 16, 525, DateTimeKind.Utc).AddTicks(7016)
                        });
                });
            ...
            modelBuilder.Entity("Repository.Entities.SubscriptionPackage", b =>
                {
                    ...
                    b.Property<bool>("HasPriorityMatching")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
